...
class TaxRate extends JsonResource
{
    public function toArray($request)
    {
        ...
        return [
            ...
            'tax_amount' => $this->tax_rate ,
            'tax_amount_symbol' => !isset($currency->symbol_position) ? $this->tax_rate  : ($currency->symbol_position == 'right' ? ($this->tax_rate ).' '.$currency->code : $currency->code.' '.($this->tax_rate )), 'currency' => $currency,
