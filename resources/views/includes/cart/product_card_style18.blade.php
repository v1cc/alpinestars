<template id="product-card-template">
    <div class="div-class">
        <div class="product product6" style="text-align: center;">
            <article>
                <div class="thumb">
                    <div class="badges">
                    </div>
                    ...
                    <div class="product-action-vertical">
                        ...
                        <a href="javascript:void(0)" class="compare-icon icon swipe-to-top" data-toggle="tooltip" data-placement="bottom"
                            title="" data-original-title="Compare"><i class="fas fa-align-right"
                                data-fa-transform="rotate-90"></i></a>
                    </div>

                </div>
                {{-- <a class="btn-secondary btn btn-block display-none icon swipe-to-top product-card-link">Add to
                    Cart</a> --}}
                <div class="content">
