<!-- //Sticky Header -->
<header id="stickyHeader" class="header-area header-one header-sticky d-none">
    <div class="header-sticky-inner  header-mini bg-top-bar bg-sticky-bar">
      <div class="container-fluid">
        <div class="row py-3">
            <div class="col-12 col-md-5 offset-1 d-flex">
            ...
            <div class="col-12 col-md-5 offset-1 without-auth-login d-flex justify-content-end">
                ...
                <ul class="link-list pro-header-options">
                    ...
                    <li class="link-item"><a href="{{ url('/login') }}" class="nav-link -before"
                            style="padding-right: 0; color: #fff;"><i class="fa fa-lock"
                                aria-hidden="true"></i>&nbsp;{{ trans('lables.header-login-register') }}</a>
                    </li>
                </ul>

            </div>
            <div class="col-12 col-md-5 auth-login d-flex justify-content-end">
