 ...
 <section class="carousel-content">
     ...
     {{-- <div id="carouselExampleWithCaptions2" class="slider-full-height carousel slide shimmer-background" data-ride="carousel">
    ...
    <a class="carousel-control-next" href="#carouselExampleWithCaptions2" role="button" data-slide="next">
     ...
     <video autoplay loop muted id="video-bg" class="video-bg">
         <source src="{{ asset('videos/RBGIFK_Smart_Jacket_LS_SPORT-ENG_TAPZWR.mp4') }}" type="video/mp4">
