<!-- Bootstrap Carousel Content with Right Banner -->
<section class="carousel-content" style="margin-top: 30px;">
  <div class="container">
    <div class="row">
      
      <div class="col-12 col-lg-8 ">
        <div id="carouselExampleIndicators5" class="carousel slide shimmer-background" data-ride="carousel">
      ...
      <div class="col-12 col-lg-4  d-none d-lg-block d-xl-block"> 
          <div class="group-banners  side-banners">
