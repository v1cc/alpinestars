  ...
  <button type="button" class="btn btn-secondary swipe-to-top vib newsletter-fix" data-toggle="modal" data-target="#newsletterModal">
    <span >Newsletter
    </span>
          ...
          <div class="modal-body">
              ...
              <div class="container">
                  ...
                  <div class="col-12 col-md-6" >
                          <div class="pro-image">
                            <img class="img-fluid" src="{{ asset('assets/front/images/miscellaneous/download (1).jpg') }}" alt="blogImage">
