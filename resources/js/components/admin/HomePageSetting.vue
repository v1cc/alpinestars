<template>
  <div>
    <div class="row">
      <div class="col-lg-12 col-xl-12">
                ...
                >
                  ...
                  <div class="inner-content">
                    <button
                      ...
                      v-if="element.multiple == true"
                      @click="toggleModal(element.name, index)"
                    >
                      Choose
                    </button>
                    <div
        ...
        <button
          ...
          style="float: right"
        >
          Update Home Page Builder Settings
        </button>
        <br />
        <br />
        <br />
    ...
    <div
      ...
      :style="[
        toggleModel ? { display: 'block !important' } : { display: 'none' },
      ]"
    >
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-body">
            <div
              v-for="(modelRenderImage, index) in modelRenderImagesArray" style="width: 100%" >
              <img
                :src="modelRenderImage[1]"
                style="width: 100%"
                :style="
                  selectedItem == modelRenderImage[1] ||
...
export default {
  ...
  data() {
    return {
      header_styles: [
        ...
        ["style9", "/assets/images/prototypes/header-styles/header9.jpg", ""],
        ["style10", "/assets/images/prototypes/header-styles/header10.jpg", ""],
        ["style11", "/assets/images/prototypes/header-styles/header11.png", ""],
      ],
      footer_styles: [
        ...
        ["style9", "/assets/images/prototypes/footer-styles/footer9.png", ""],
        ["style10", "/assets/images/prototypes/footer-styles/footer10.png", ""],
        ["style11", "/assets/images/prototypes/footer-styles/footer11.png", ""],
      ],
      carousal_styles: [
        [
          "style1",
          "/assets/images/prototypes/carousal-styles/carousal1.jpg",
          "",
        ],
        [
          "style2",
          "/assets/images/prototypes/carousal-styles/carousal2.jpg",
          "",
        ],
        [
          "style3",
          "/assets/images/prototypes/carousal-styles/carousal3.jpg",
          "",
        ],
        [
          "style4",
          "/assets/images/prototypes/carousal-styles/carousal4.jpg",
          "",
        ],
        [
          "style5",
          "/assets/images/prototypes/carousal-styles/carousal5.jpg",
          "",
        ],
        [
          "style6",
          "/assets/images/prototypes/carousal-styles/carousal6.jpg",
          "",
        ],
      ],
      banner_styles: [
  ...
  methods: {
    fetchHomePageSetting() {
      ...
      axios
        .get("/api/admin/current-theme", config)
        .then((res) => {
            ...
            for (var i = 0; i < res.data.data.length; i++) {
              if (res.data.data[i].setting_key == "header_style") {
                ...
                for (var j = 0; j < this.header_styles.length; j++) {
                  if (
                    res.data.data[i].setting_value == this.header_styles[j][0]
                  ) {
                    index1 = j;
                  } else {
              ...
              if (res.data.data[i].setting_key == "Footer_style") {
                ...
                for (var j = 0; j < this.footer_styles.length; j++) {
                  if (
                    res.data.data[i].setting_value == this.footer_styles[j][0]
                  ) {
                    index1 = j;
                  } else {
              ...
              if (res.data.data[i].setting_key == "slider_style") {
                ...
                for (var j = 0; j < this.carousal_styles.length; j++) {
                  if (
                    res.data.data[i].setting_value == this.carousal_styles[j][0]
                  ) {
                    index1 = i;
                  } else {
              ...
              if (res.data.data[i].setting_key == "banner_style") {
                ...
                for (var j = 0; j < this.banner_styles.length; j++) {
                  if (
                    res.data.data[i].setting_value == this.banner_styles[j][0]
                  ) {
                    index1 = j;
                  } else {
