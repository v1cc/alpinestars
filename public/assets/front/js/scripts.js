...
jQuery(document).ready(function(){
    var quantitiy=0;
    jQuery('.quantity-plus22').click(function(e){
        
        // Stop acting like a button
        e.preventDefault();
        // Get the field name
        var quantity = parseInt(jQuery('#quantity22').val());
        
        // If is not undefined
            
        jQuery('#quantity22').val(quantity + 1);

        // Increment
        
    });

    jQuery('.quantity-minus22').click(function(e){
        // Stop acting like a button
        e.preventDefault();
        // Get the field name
        var quantity = parseInt(jQuery('#quantity22').val());
...
jQuery(document).ready(function(){
    var quantitiy=0;
    jQuery('.quantity-plus21').click(function(e){
        
        // Stop acting like a button
        e.preventDefault();
        // Get the field name
        var quantity = parseInt(jQuery('#quantity21').val());
        
        // If is not undefined
            
        jQuery('#quantity21').val(quantity + 1);

        // Increment
        
    });

    jQuery('.quantity-minus21').click(function(e){
        // Stop acting like a button
        e.preventDefault();
        // Get the field name
        var quantity = parseInt(jQuery('#quantity21').val());
...
jQuery(document).on("click","#switchColor a", function(){
    ...
    if(cssValue == "default"){
        jQuery('link[rel=stylesheet][href="css/brown.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/dark-brown.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/green.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/purple.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/red.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/light-yellow.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/light-blue.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/pink.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/orange.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/light-gray.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/light-purple.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/light-pink.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/gray.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/light-green.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/zinc.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/dark-green.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/light-zinc.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/light-maroon.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/black.css"]').remove();

    }
    else if(cssValue == "brown"){
        jQuery('head').append('<link type="text/css" rel="stylesheet" href="css/brown.css">');
    ...
    else if(cssValue == "dark-brown"){
        jQuery('head').append('<link type="text/css" rel="stylesheet" href="css/dark-brown.css">');
        jQuery('link[rel=stylesheet][href="css/default.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/brown.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/green.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/purple.css"]').remove();
    ...
    else if(cssValue == "purple"){
        jQuery('head').append('<link type="text/css" rel="stylesheet" href="css/purple.css">');
        jQuery('link[rel=stylesheet][href="css/default.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/dark-brown.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/green.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/brown.css"]').remove();
    ...
    else if(cssValue == "light-yellow"){
        jQuery('head').append('<link type="text/css" rel="stylesheet" href="css/light-yellow.css">');
        jQuery('link[rel=stylesheet][href="css/default.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/dark-brown.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/green.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/purple.css"]').remove();
    ...
    else if(cssValue == "light-blue"){
        jQuery('head').append('<link type="text/css" rel="stylesheet" href="css/light-blue.css">');
        jQuery('link[rel=stylesheet][href="css/default.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/dark-brown.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/green.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/purple.css"]').remove();
    ...
    else if(cssValue == "orange"){
        jQuery('head').append('<link type="text/css" rel="stylesheet" href="css/orange.css">');
        jQuery('link[rel=stylesheet][href="css/default.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/dark-brown.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/green.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/purple.css"]').remove();
    ...
    else if(cssValue == "light-gray"){
        jQuery('head').append('<link type="text/css" rel="stylesheet" href="css/light-gray.css">');
        jQuery('link[rel=stylesheet][href="css/default.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/dark-brown.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/green.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/purple.css"]').remove();
    ...
    else if(cssValue == "light-purple"){
        jQuery('head').append('<link type="text/css" rel="stylesheet" href="css/light-purple.css">');
        jQuery('link[rel=stylesheet][href="css/default.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/dark-brown.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/green.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/purple.css"]').remove();
    ...
    else if(cssValue == "light-pink"){
        jQuery('head').append('<link type="text/css" rel="stylesheet" href="css/light-pink.css">');
        jQuery('link[rel=stylesheet][href="css/default.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/dark-brown.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/green.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/purple.css"]').remove();
    ...
    else if(cssValue == "gray"){
        jQuery('head').append('<link type="text/css" rel="stylesheet" href="css/gray.css">');
        jQuery('link[rel=stylesheet][href="css/default.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/dark-brown.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/green.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/purple.css"]').remove();
    ...
    else if(cssValue == "light-green"){
        jQuery('head').append('<link type="text/css" rel="stylesheet" href="css/light-green.css">');
        jQuery('link[rel=stylesheet][href="css/default.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/dark-brown.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/green.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/purple.css"]').remove();
    ...
    else if(cssValue == "zinc"){
        jQuery('head').append('<link type="text/css" rel="stylesheet" href="css/zinc.css">');
        jQuery('link[rel=stylesheet][href="css/default.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/dark-brown.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/green.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/purple.css"]').remove();
    ...
    else if(cssValue == "dark-green"){
        jQuery('head').append('<link type="text/css" rel="stylesheet" href="css/dark-green.css">');
        jQuery('link[rel=stylesheet][href="css/default.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/dark-brown.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/green.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/purple.css"]').remove();
    ...
    else if(cssValue == "light-zinc"){
        jQuery('head').append('<link type="text/css" rel="stylesheet" href="css/light-zinc.css">');
        jQuery('link[rel=stylesheet][href="css/default.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/dark-brown.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/green.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/purple.css"]').remove();
    ...
    else if(cssValue == "light-maroon"){
        jQuery('head').append('<link type="text/css" rel="stylesheet" href="css/light-maroon.css">');
        jQuery('link[rel=stylesheet][href="css/default.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/dark-brown.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/green.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/purple.css"]').remove();
    ...
    else if(cssValue == "black"){
        jQuery('head').append('<link type="text/css" rel="stylesheet" href="css/black.css">');
        jQuery('link[rel=stylesheet][href="css/default.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/dark-brown.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/green.css"]').remove();
        jQuery('link[rel=stylesheet][href="css/purple.css"]').remove();
...
jQuery(document).on('click', function(event) {
	if (!jQuery(event.target).closest('.left-panel').length)  {
		jQuery(".left-panel").removeClass("demo-panel-open");
	}
});


    function showHeaderImage(){
        var header_id = parseInt(jQuery('#header_id').val().replace ( /[^\d.]/g, '' ));
        jQuery('#header_image1').hide();
        jQuery('#header_image2').hide();
        jQuery('#header_image3').hide();
        jQuery('#header_image4').hide();
        jQuery('#header_image5').hide();
        jQuery('#header_image6').hide();
        jQuery('#header_image7').hide();
        jQuery('#header_image8').hide();
        jQuery('#header_image9').hide();
        jQuery('#header_image10').hide();
        //alert (header_id);
        if(header_id == 1){
            
        jQuery('#header_image1').show();
        }
        if(header_id == 2){
        jQuery('#header_image2').show();
        }
        if(header_id == 3){
        jQuery('#header_image3').show();
        }
        if(header_id == 4){
        jQuery('#header_image4').show();
        }
        if(header_id == 5){
        jQuery('#header_image5').show();
        }
        if(header_id == 6){
        jQuery('#header_image6').show();
        }
        if(header_id == 7){
        jQuery('#header_image7').show();
        }
        if(header_id == 8){
        jQuery('#header_image8').show();
        }
        if(header_id == 9){
        jQuery('#header_image9').show();
        }
        if(header_id == 10){
        jQuery('#header_image10').show();
        }

    }
    function showFooterImage(){
        var footer_id = parseInt(jQuery('#footer_id').val().replace ( /[^\d.]/g, '' ));
        jQuery('#footer_image1').hide();
        jQuery('#footer_image2').hide();
        jQuery('#footer_image3').hide();
        jQuery('#footer_image4').hide();
        jQuery('#footer_image5').hide();
        jQuery('#footer_image6').hide();
        jQuery('#footer_image7').hide();
        jQuery('#footer_image8').hide();
        jQuery('#footer_image9').hide();
        jQuery('#footer_image10').hide();

        if(footer_id == 1){
        jQuery('#footer_image1').show();
        }
        if(footer_id == 2){
        jQuery('#footer_image2').show();
        }
        if(footer_id == 3){
        jQuery('#footer_image3').show();
        }
        if(footer_id == 4){
        jQuery('#footer_image4').show();
        }
        if(footer_id == 5){
        jQuery('#footer_image5').show();
        }
        if(footer_id == 6){
        jQuery('#footer_image6').show();
        }
        if(footer_id == 7){
        jQuery('#footer_image7').show();
        }
        if(footer_id == 8){
        jQuery('#footer_image8').show();
        }
        if(footer_id == 9){
        jQuery('#footer_image9').show();
        }
        if(footer_id == 10){
        jQuery('#footer_image10').show();
        }

    }
    // function showSliderImage(){
    //     var slider_id = parseInt(jQuery('#slider_id').val().replace ( /[^\d.]/g, '' ));
    //     jQuery('#slider_image1').hide();
    //     jQuery('#slider_image2').hide();
    //     jQuery('#slider_image3').hide();
    //     jQuery('#slider_image4').hide();
    //     jQuery('#slider_image5').hide();
    //     jQuery('#slider_image6').hide();


    //     if(slider_id == 1){
    //     jQuery('#slider_image1').show();
    //     }
    //     if(slider_id == 2){
    //     jQuery('#slider_image2').show();
    //     }
    //     if(slider_id == 3){
    //     jQuery('#slider_image3').show();
    //     }
    //     if(slider_id == 4){
    //     jQuery('#slider_image4').show();
    //     }
    //     if(slider_id == 5){
    //     jQuery('#slider_image5').show();
    //     }

    // }
    // function showBannerImage(){
    //     var banner_id = parseInt(jQuery('#banner_id').val().replace ( /[^\d.]/g, '' ));
    //     jQuery('#banner_image1').hide();
    //     jQuery('#banner_image2').hide();
    //     jQuery('#banner_image3').hide();
    //     jQuery('#banner_image4').hide();
    //     jQuery('#banner_image5').hide();
    //     jQuery('#banner_image6').hide();
    //     jQuery('#banner_image7').hide();
    //     jQuery('#banner_image8').hide();
    //     jQuery('#banner_image9').hide();
    //     jQuery('#banner_image10').hide();
    //     jQuery('#banner_image11').hide();
    //     jQuery('#banner_image12').hide();
    //     jQuery('#banner_image13').hide();
    //     jQuery('#banner_image14').hide();
    //     jQuery('#banner_image15').hide();
    //     jQuery('#banner_image16').hide();
    //     jQuery('#banner_image17').hide();
    //     jQuery('#banner_image18').hide();
    //     jQuery('#banner_image19').hide();
 
 
    //     if(banner_id == 1){
    //       jQuery('#banner_image1').show();
    //     }
    //     if(banner_id == 2){
    //       jQuery('#banner_image2').show();
    //     }
    //     if(banner_id == 3){
    //       jQuery('#banner_image3').show();
    //     }
    //     if(banner_id == 4){
    //       jQuery('#banner_image4').show();
    //     }
    //     if(banner_id == 5){
    //       jQuery('#banner_image5').show();
    //     }
    //     if(banner_id == 6){
    //       jQuery('#banner_image6').show();
    //     }
    //     if(banner_id == 7){
    //       jQuery('#banner_image7').show();
    //     }
    //     if(banner_id == 8){
    //       jQuery('#banner_image8').show();
    //     }
    //     if(banner_id == 9){
    //       jQuery('#banner_image9').show();
    //     }
    //     if(banner_id == 10){
    //       jQuery('#banner_image10').show();
    //     }
    //     if(banner_id == 11){
    //       jQuery('#banner_image11').show();
    //     }
    //     if(banner_id == 12){
    //       jQuery('#banner_image12').show();
    //     }
    //     if(banner_id == 13){
    //       jQuery('#banner_image13').show();
    //     }
    //     if(banner_id == 14){
    //       jQuery('#banner_image14').show();
    //     }
    //     if(banner_id == 15){
    //       jQuery('#banner_image15').show();
    //     }
    //     if(banner_id == 16){
    //       jQuery('#banner_image16').show();
    //     }
    //     if(banner_id == 17){
    //       jQuery('#banner_image17').show();
    //     }
    //     if(banner_id == 18){
    //       jQuery('#banner_image18').show();
    //     }
    //     if(banner_id == 19){
    //       jQuery('#banner_image19').show();
    //     }
 
    // }

    // function showCardImage(){
    //     var banner_id = parseInt(jQuery('#cart_id').val().replace ( /[^\d.]/g, '' ));
    ...
    //     var product_id = parseInt(jQuery('#product_page_style').val().replace ( /[^\d.]/g, '' ));
    //     jQuery('#product_image1').hide();
    //     jQuery('#product_image2').hide();
    //     jQuery('#product_image3').hide();
    //     jQuery('#product_image4').hide();
    //     jQuery('#product_image5').hide();
 
 
    //     if(product_id == 1){
    //       jQuery('#product_image1').show();
    //     }
    //     if(product_id == 2){
    //       jQuery('#product_image2').show();
    //     }
    //     if(product_id == 3){
    //       jQuery('#product_image3').show();
    //     }
    //     if(product_id == 4){
    //       jQuery('#product_image4').show();
    //     }
    //     if(product_id == 5){
    //       jQuery('#product_image5').show();
    //     }
    // }
    // function showShopImage(){
    //     var shop_id = parseInt(jQuery('#shop_style').val().replace ( /[^\d.]/g, '' ));
